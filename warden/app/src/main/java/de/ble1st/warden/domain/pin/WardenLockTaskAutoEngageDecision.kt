 ...
 *    (s. `de.ble1st.warden.sentinel.domain.SentinelLockTaskGate`/`de.ble1st.warden.pin
 *    .WardenLockTaskDrillStorage`).
 ...
 * Anforderung tatsächlich eingelöst wird (`de.ble1st.warden.sentinelbridge
 * .SentinelLockdownEngager.engage` über `SensitiveAction.LOCKDOWN_TASK_ENGAGE`) — eine
 * vorgemerkte, aber nie ausgeführte Anforderung auf
