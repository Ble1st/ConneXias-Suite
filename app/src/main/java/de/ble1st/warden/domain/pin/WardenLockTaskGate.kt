 ...
 * nicht wie erwartet funktioniert) — dieses Gate existiert und ist getestet,
 * `WardenLockTaskManager.startLockTask()` wird deshalb aktuell nirgends automatisch aufgerufen.
 *
